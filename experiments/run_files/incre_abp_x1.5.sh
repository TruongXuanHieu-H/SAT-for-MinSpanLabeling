...
report_dir="../../experiments/results/incre_abp_x1.5"
...
$build_dir/mmsl_enc $dataset_dir/L-bcspwr03.mtx.rnd    -target-value 59     -set-lb 60  -set-ub 177     $general_config >> $report_dir/L-bcspwr03.txt

...
report_dir="$ROOT_DIR/experiments/results/cabp/incremental/reduced_bound/incre_cabp_x0.75-10"

time_limit="1800"
memory_limit="30000"
general_config="--cabp --ladder --no-hole --verify-result --incremental-from-ub -limit-memory $memory_limit -limit-real-time $time_limit -symmetry-break highest-degree -max-cnf-size 10"

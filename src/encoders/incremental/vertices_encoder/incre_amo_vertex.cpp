...
void IncreAMOVertex::encode_at_most_one_product(const IncreInstanceData &instance_data, const std::vector<int> &vars)
{
    if (vars.size() < 2)
        return;
    if (vars.size() == 2)
...
void IncreAMOVertex::encode_amo_seq(const IncreInstanceData &instance_data, const std::vector<int> &vars)
{
    if (vars.size() < 2)
        return;
...
void IncreAMOVertex::ignore_label(const IncreInstanceData &instance_data, int label)
{

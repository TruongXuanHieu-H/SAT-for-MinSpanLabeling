...
IncreLadder::IncreLadder(IncreInstanceData &instance_data) : IncreEncoder(instance_data) {}
...
void IncreLadder::encode_at_least_one_naive(const std::vector<int> &vars)
{

...
MMSLInstance::MMSLInstance(int width)
{
    InstanceData::width = width;
}

MMSLInstance::~MMSLInstance() {};
...
*/
int MMSLInstance::encode_and_solve_abp()
{
...
int MMSLInstance::verify_solution()
{
...
void MMSLInstance::encode_and_print_dimacs()
{

...
int VarHandler::get_new_var() { return next_to_assign++; };

int VarHandler::last_var() const { return next_to_assign - 1; };

int VarHandler::size() const { return next_to_assign - first_assigned_id; };